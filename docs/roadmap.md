...
- ✅ [`docs/system/config_protocol.md`](system/config_protocol.md) - 配置协议 v1.0
- ✅ [`docs/system/ui_bridge_protocol.md`](system/ui_bridge_protocol.md) - UI 桥接协议 v1.0
