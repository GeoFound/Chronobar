...
**想第一时间收到 M2 可用通知？** → [Watch 本仓库](https://github.com/GeoFound/Chronobar/subscription) 或 [加入讨论](https://github.com/GeoFound/Chronobar/discussions)
